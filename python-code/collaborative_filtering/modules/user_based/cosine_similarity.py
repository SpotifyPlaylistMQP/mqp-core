...
def run(playlist_dict, playlist_ids, input_playlist_id, playlist_track_matrix, new_playlist_tracks, K, N):
    cosine_similarities = create(playlist_ids, input_playlist_id, playlist_track_matrix)
