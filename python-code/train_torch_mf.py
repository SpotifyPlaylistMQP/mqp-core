...
all_params = {
    "mpd_square_100": {
        "alpha_set": [1e-17, 1e-18, 1e16, 1e15, 1e14, 1e13, 1e12, 1e11, 1e10, 1e9, 1e8, 1e7, 1e6, 1e5, 1e4, 1e3, 1e2, 1, 1e-1, 1e-2, 1e-3, 1e-4],
        "latent_features_set": [5, 10, 50, 75, 100, 150, 200, 300, 500],
        "learning_rate_set": [1e-4, 1e-5, 1e-6, 1e-7, 1e-8, 1e-9, 1e-10, 1e-11, 1e-12, 1e-13, 1e-14, 1e-15],
        "percent_zeros_set": [0.5],
        ...
        for learning_rate in params["learning_rate_set"]:
            for percent_zeros in params["percent_zeros_set"]:
                for optimizer in params["optimizer_set"]:
                    ...
                    print("{}, {},  {}, {}, {}, NDCG:{}".format(alpha, latent_features, learning_rate, percent_zeros, optimizer, avg_ndcg))
                    output.write("{}, {}, {}, {}, {}, {}\n".format(alpha, latent_features, learning_rate, percent_zeros, optimizer, avg_ndcg))
